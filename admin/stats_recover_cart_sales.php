<?php
/*
 $Id: stats_recover_cart_sales.php, v4.2.00 2026-05-09OldNGrey
 HISTORY
 - $Id: stats_recover_cart_sales.php, v4.00.00a 2012/04/23 testuser -> iChoze -> Zen Cart v1.5 $ Exp $
 - Recover Cart Sales Report v2.11
 - Recover Cart Sales contribution: JM Ivler 11/20/03   (c) Ivler / Ideas From the Deep / osCommerce   Released under the GNU General Public License
 ...
 BMH 2026-05-09 update doc header; reformatted; appended customer id to customer name (I have customes with identical names); appended version number to title
 V4.2.00
*/
require('includes/application_top.php');
require(DIR_WS_CLASSES . 'currencies.php');
const RECOVER_CART_SALES_REPORT_VERSION = '4.2.00'; // BMH 2026-05-09 - created and updated version number
                ...
                <table border="0" width="100%" cellspacing="0" cellpadding="2">
                    <tr>
                        <td width="100%">
                            <table border="0" width="100%" cellspacing="2" cellpadding="2">
                                <tr>
                                    <td class="pageHeading"><?php echo HEADING_TITLE . '  Version: ' . RECOVER_CART_SALES_REPORT_VERSION; ?></td>
                        ...
                        <td width="100%">
                            <table border="0" width="100%" cellspacing="2" cellpadding="2">
                                ...
                                <tr class="dataTableHeadingRow">
                                    <th width="4%" class="dataTableHeadingContent"><?php echo TABLE_HEADING_SCART_ID ?>
                        </td>
                        <th width="8%" class="dataTableHeadingContent"><?php echo TABLE_HEADING_SCART_ADD_DATE ?>
            </td>
        ...
        foreach ($cust_array as $cust) {
            ...
            <tr class="<?php echo ($i % 2 ? RCS_REPORT_EVEN_STYLE : RCS_REPORT_ODD_STYLE); ?>">
                ...
                <td class="dataTableContent"><a
                    href="<?php echo zen_href_link(FILENAME_CUSTOMERS, "search=" . $cust['customers_email_address']); ?>"><?php echo $cust['customers_firstname'] . " " . $cust['customers_lastname'] . ' (#' .$cust['customers_id'] . ')'; ?></a>
                </td>
    ...
    <tr>
        <td width="100%">
            <table border="0" width="100%" cellspacing="2" cellpadding="2">
                <tr>
                    <td valign="bottom">
                        <hr width="100%" size="1" color="#800000" noshade>
                    </td>
                </tr>
                <tr>
                    <td align="right" class="main">
                        <b><?php echo TOTAL_RECOVERED; ?>&nbsp;<?php echo $rc_cnt ? zen_round(($custknt / $rc_cnt) * 100, 2) : 0 ?>%&nbsp;&nbsp;<?php echo $currencies->format(zen_round($total_recovered, 2)); ?></b>
                    </td>
                </tr>
            </table>
        </td>
